    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="etfTestV1App.etfUnderlying.home.createOrEditLabel">
              <Translate contentKey="etfTestV1App.etfUnderlying.home.createOrEditLabel">Create or edit a EtfUnderlying</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : etfUnderlyingEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="etf-underlying-my-suffix-id">
                ...
                <AvGroup>
                  <Label for="etf-underlying-my-suffix-etfProduct">
