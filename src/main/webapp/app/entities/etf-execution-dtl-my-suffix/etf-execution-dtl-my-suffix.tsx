    ...
    return (
      <div>
        <h2 id="etf-execution-dtl-my-suffix-heading">
          <Translate contentKey="etfTestV1App.etfExecutionDtl.home.title">Etf Execution Dtls</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="etfTestV1App.etfExecutionDtl.home.createLabel">Create a new Etf Execution Dtl</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {etfExecutionDtlList && etfExecutionDtlList.length > 0 ? (
            <Table responsive aria-describedby="etf-execution-dtl-my-suffix-heading">
              <thead>
                <tr>
                  <th>
              ...
              <tbody>
                {etfExecutionDtlList.map((etfExecutionDtl, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {etfExecutionDtl.etfExecutionId ? (
                        <Link to={`etf-execution-my-suffix/${etfExecutionDtl.etfExecutionId}`}>{etfExecutionDtl.etfExecutionId}</Link>
                      ) : (
                        ''
                      )}
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="etfTestV1App.etfExecutionDtl.home.notFound">No Etf Execution Dtls found</Translate>
            </div>
          )}
        </div>
      </div>
