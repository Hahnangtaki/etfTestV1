    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="etfTestV1App.etfExecutionDtl.home.createOrEditLabel">
              <Translate contentKey="etfTestV1App.etfExecutionDtl.home.createOrEditLabel">Create or edit a EtfExecutionDtl</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : etfExecutionDtlEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="etf-execution-dtl-my-suffix-id">
                ...
                <AvGroup>
                  <Label for="etf-execution-dtl-my-suffix-etfExecution">
