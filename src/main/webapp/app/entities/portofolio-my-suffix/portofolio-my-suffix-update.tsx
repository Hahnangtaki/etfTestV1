    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="etfTestV1App.portofolio.home.createOrEditLabel">
              <Translate contentKey="etfTestV1App.portofolio.home.createOrEditLabel">Create or edit a Portofolio</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : portofolioEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="portofolio-my-suffix-id">
                ...
                <AvGroup>
                  <Label for="portofolio-my-suffix-etfProduct">
