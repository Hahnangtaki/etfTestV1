    ...
    return (
      <div>
        <h2 id="dealer-participant-my-suffix-heading">
          <Translate contentKey="etfTestV1App.dealerParticipant.home.title">Dealer Participants</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="etfTestV1App.dealerParticipant.home.createLabel">Create a new Dealer Participant</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {dealerParticipantList && dealerParticipantList.length > 0 ? (
            <Table responsive aria-describedby="dealer-participant-my-suffix-heading">
              <thead>
                <tr>
                  <th>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="etfTestV1App.dealerParticipant.home.notFound">No Dealer Participants found</Translate>
            </div>
          )}
        </div>
      </div>
