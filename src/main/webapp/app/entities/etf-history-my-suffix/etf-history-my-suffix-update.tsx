    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="etfTestV1App.etfHistory.home.createOrEditLabel">
              <Translate contentKey="etfTestV1App.etfHistory.home.createOrEditLabel">Create or edit a EtfHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : etfHistoryEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="etf-history-my-suffix-id">
                ...
                <AvGroup>
                  <Label for="etf-history-my-suffix-etfProduct">
