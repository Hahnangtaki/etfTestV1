    ...
    return (
      <div>
        <h2 id="etf-underlying-dtl-my-suffix-heading">
          <Translate contentKey="etfTestV1App.etfUnderlyingDtl.home.title">Etf Underlying Dtls</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="etfTestV1App.etfUnderlyingDtl.home.createLabel">Create a new Etf Underlying Dtl</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {etfUnderlyingDtlList && etfUnderlyingDtlList.length > 0 ? (
            <Table responsive aria-describedby="etf-underlying-dtl-my-suffix-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="etfTestV1App.etfUnderlyingDtl.stockCode">Stock Code</Translate>
                  </th>
                  <th>
                    <Translate contentKey="etfTestV1App.etfUnderlyingDtl.weight">Weight</Translate>
                  </th>
                  <th>
                    <Translate contentKey="etfTestV1App.etfUnderlyingDtl.etfUnderlying">Etf Underlying</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="etfTestV1App.etfUnderlyingDtl.home.notFound">No Etf Underlying Dtls found</Translate>
            </div>
          )}
        </div>
      </div>
