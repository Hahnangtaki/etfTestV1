    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="etfTestV1App.etfUnderlyingDtl.home.createOrEditLabel">
              <Translate contentKey="etfTestV1App.etfUnderlyingDtl.home.createOrEditLabel">Create or edit a EtfUnderlyingDtl</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : etfUnderlyingDtlEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="etf-underlying-dtl-my-suffix-id">
                ...
                <AvGroup>
                  <Label for="etf-underlying-dtl-my-suffix-etfUnderlying">
