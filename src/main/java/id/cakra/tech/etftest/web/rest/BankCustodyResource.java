...
import id.cakra.tech.etftest.service.BankCustodyService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.BankCustody}.
 */
@RestController
@RequestMapping("/api")
public class BankCustodyResource {
    ...
    public ResponseEntity<BankCustodyDTO> updateBankCustody(@Valid @RequestBody BankCustodyDTO bankCustodyDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, bankCustodyDTO.getId().toString()))
            .body(result);
    }
