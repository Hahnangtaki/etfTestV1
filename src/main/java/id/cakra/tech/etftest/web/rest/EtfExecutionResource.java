...
import id.cakra.tech.etftest.service.EtfExecutionService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.EtfExecution}.
 */
@RestController
@RequestMapping("/api")
public class EtfExecutionResource {
    ...
    public ResponseEntity<EtfExecutionDTO> updateEtfExecution(@Valid @RequestBody EtfExecutionDTO etfExecutionDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, etfExecutionDTO.getId().toString()))
            .body(result);
    }
