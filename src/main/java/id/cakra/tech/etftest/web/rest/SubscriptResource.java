...
import id.cakra.tech.etftest.service.SubscriptService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.Subscript}.
 */
@RestController
@RequestMapping("/api")
public class SubscriptResource {
    ...
    public ResponseEntity<SubscriptDTO> updateSubscript(@Valid @RequestBody SubscriptDTO subscriptDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, subscriptDTO.getId().toString()))
            .body(result);
    }
