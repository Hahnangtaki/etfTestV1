...
import id.cakra.tech.etftest.service.DealerParticipantService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.DealerParticipant}.
 */
@RestController
@RequestMapping("/api")
public class DealerParticipantResource {
    ...
    public ResponseEntity<DealerParticipantDTO> updateDealerParticipant(@Valid @RequestBody DealerParticipantDTO dealerParticipantDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, dealerParticipantDTO.getId().toString()))
            .body(result);
    }
