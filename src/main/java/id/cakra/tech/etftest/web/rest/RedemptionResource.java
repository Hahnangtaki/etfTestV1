...
import id.cakra.tech.etftest.service.RedemptionService;
import id.cakra.tech.etftest.web.rest.errors.BadRequestAlertException;
import id.cakra.tech.etftest.service.dto.RedemptionDTO;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.Redemption}.
 */
@RestController
@RequestMapping("/api")
public class RedemptionResource {
    ...
    public ResponseEntity<RedemptionDTO> updateRedemption(@Valid @RequestBody RedemptionDTO redemptionDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, redemptionDTO.getId().toString()))
            .body(result);
    }
