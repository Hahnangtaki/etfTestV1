...
import id.cakra.tech.etftest.service.EtfExecutionDtlService;
import id.cakra.tech.etftest.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.EtfExecutionDtl}.
 */
@RestController
@RequestMapping("/api")
public class EtfExecutionDtlResource {
    ...
    public ResponseEntity<EtfExecutionDtlDTO> createEtfExecutionDtl(@RequestBody EtfExecutionDtlDTO etfExecutionDtlDTO) throws URISyntaxException {
    ...
    public ResponseEntity<EtfExecutionDtlDTO> updateEtfExecutionDtl(@RequestBody EtfExecutionDtlDTO etfExecutionDtlDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, etfExecutionDtlDTO.getId().toString()))
            .body(result);
    }
