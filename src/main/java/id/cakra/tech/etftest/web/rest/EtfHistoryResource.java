...
import id.cakra.tech.etftest.service.EtfHistoryService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.EtfHistory}.
 */
@RestController
@RequestMapping("/api")
public class EtfHistoryResource {
    ...
    public ResponseEntity<EtfHistoryDTO> createEtfHistory(@RequestBody EtfHistoryDTO etfHistoryDTO) throws URISyntaxException {
    ...
    public ResponseEntity<EtfHistoryDTO> updateEtfHistory(@RequestBody EtfHistoryDTO etfHistoryDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, etfHistoryDTO.getId().toString()))
            .body(result);
    }
