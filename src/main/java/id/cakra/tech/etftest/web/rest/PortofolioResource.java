...
import id.cakra.tech.etftest.service.PortofolioService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.Portofolio}.
 */
@RestController
@RequestMapping("/api")
public class PortofolioResource {
    ...
    public ResponseEntity<PortofolioDTO> updatePortofolio(@RequestBody PortofolioDTO portofolioDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, portofolioDTO.getId().toString()))
            .body(result);
    }
