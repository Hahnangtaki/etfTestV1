...
import id.cakra.tech.etftest.service.EtfUnderlyingDtlService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.EtfUnderlyingDtl}.
 */
@RestController
@RequestMapping("/api")
public class EtfUnderlyingDtlResource {
    ...
    public ResponseEntity<EtfUnderlyingDtlDTO> updateEtfUnderlyingDtl(@Valid @RequestBody EtfUnderlyingDtlDTO etfUnderlyingDtlDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, etfUnderlyingDtlDTO.getId().toString()))
            .body(result);
    }
