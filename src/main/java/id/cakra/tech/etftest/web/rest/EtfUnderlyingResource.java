...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.EtfUnderlying}.
 */
@RestController
@RequestMapping("/api")
public class EtfUnderlyingResource {
    ...
    public ResponseEntity<EtfUnderlyingDTO> createEtfUnderlying(@RequestBody EtfUnderlyingDTO etfUnderlyingDTO) throws URISyntaxException {
    ...
    public ResponseEntity<EtfUnderlyingDTO> updateEtfUnderlying(@RequestBody EtfUnderlyingDTO etfUnderlyingDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, etfUnderlyingDTO.getId().toString()))
            .body(result);
    }
