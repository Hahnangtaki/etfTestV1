...
import id.cakra.tech.etftest.service.MiService;
...
/**
 * REST controller for managing {@link id.cakra.tech.etftest.domain.Mi}.
 */
@RestController
@RequestMapping("/api")
public class MiResource {
    ...
    public ResponseEntity<MiDTO> updateMi(@Valid @RequestBody MiDTO miDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, miDTO.getId().toString()))
            .body(result);
    }
