...
/**
 * A DTO for the {@link id.cakra.tech.etftest.domain.EtfExecutionDtl} entity.
 */
public class EtfExecutionDtlDTO implements Serializable {
    ...
    public Long getEtfExecutionId() {
        return etfExecutionId;
    }

    public void setEtfExecutionId(Long etfExecutionId) {
        this.etfExecutionId = etfExecutionId;
    }
    ...
    public String toString() {
        return "EtfExecutionDtlDTO{" +
            ...
            ", etfExecution=" + getEtfExecutionId() +
            "}";
    }
}
