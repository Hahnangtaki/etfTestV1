package id.cakra.tech.etftest.domain;
...
public class EtfExecution implements Serializable {
    ...
    @OneToMany(mappedBy = "etfExecution")
    private Set<EtfExecutionDtl> etfExecutionDtls = new HashSet<>();
    ...
    public Set<EtfExecutionDtl> getEtfExecutionDtls() {
        return etfExecutionDtls;
    }

    public EtfExecution etfExecutionDtls(Set<EtfExecutionDtl> etfExecutionDtls) {
        this.etfExecutionDtls = etfExecutionDtls;
        return this;
    }

    public EtfExecution addEtfExecutionDtl(EtfExecutionDtl etfExecutionDtl) {
        this.etfExecutionDtls.add(etfExecutionDtl);
        etfExecutionDtl.setEtfExecution(this);
        return this;
    }

    public EtfExecution removeEtfExecutionDtl(EtfExecutionDtl etfExecutionDtl) {
        this.etfExecutionDtls.remove(etfExecutionDtl);
        etfExecutionDtl.setEtfExecution(null);
        return this;
    }

    public void setEtfExecutionDtls(Set<EtfExecutionDtl> etfExecutionDtls) {
        this.etfExecutionDtls = etfExecutionDtls;
    }
